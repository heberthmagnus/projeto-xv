...
import { createRegistration } from "../../tio-hugo-2026/inscricao/actions";
import { initialRegistrationFormState } from "../../tio-hugo-2026/inscricao/form-state";
  ...
  return (
    ...
    >
      ...
      >
        ...
        acontecerão aos sábados às 14h00 e 15h30, e aos domingos às 08h00,
        09h40 e 11h30.
      </div>
      ...
      >
        ...
        />
        <span>
          Confirmo que li e estou ciente de que os jogos acontecerão aos
          sábados às 14h00 e 15h30, e aos domingos às 08h00, 09h40 e 11h30,
          conforme a categoria da inscrição, além das informações de valores e
          formas de pagamento.
        </span>
      </label>
